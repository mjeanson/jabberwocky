...
public class Lttng29EventLayout extends Lttng28EventLayout {
    ...
    private static final String FIELD_VARIANT_SELECTED = "Any"; //$NON-NLS-1$

    private static final String[] TCP_SEQ_FIELD = { "network_header", FIELD_VARIANT_SELECTED, "transport_header", "tcp", "seq" }; //$NON-NLS-1$//$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    private static final String[] TCP_ACK_FIELD = { "network_header", FIELD_VARIANT_SELECTED, "transport_header", "tcp", "ack_seq" }; //$NON-NLS-1$//$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    private static final String[] TCP_FLAGS_FIELD = { "network_header", FIELD_VARIANT_SELECTED, "transport_header", "tcp", "flags" }; //$NON-NLS-1$//$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
