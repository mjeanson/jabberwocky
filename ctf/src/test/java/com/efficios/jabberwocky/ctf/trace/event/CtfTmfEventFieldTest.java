...
public class CtfTmfEventFieldTest {
    ...
    public void testParseField_float() {
        ...
        IFieldValue result = CtfTraceEventFieldParser.parseField(fieldDef);
    ...
    public void testParseField_sequence_value() {
        ...
        ArrayValue<IntegerValue> result = (ArrayValue<IntegerValue>) CtfTraceEventFieldParser.parseField(fieldDef);
        long[] values = IntStream.range(0, result.size())
                .mapToObj(result::getElement)
